...
public class ItemsList {
	...
	public void testItemsList () throws InterruptedException, IOException {
		...
		// Wait till field is loaded on the page
    	WebDriverWait wait = new WebDriverWait(dv, Duration.ofSeconds(10));
    	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("cb1-edit")));
		...
		for (int i = 1; i <= 3; i++) {
        	...
        	WebDriverWait wait2 = new WebDriverWait(dv, Duration.ofSeconds(10));
        	wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@class='ui-search-layout__item']")));
	        ...
	        for (WebElement elemento : elementos) {
	            ...
	            //Create a new Articulo object and add items  to the  articulos list
